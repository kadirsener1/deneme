...
class TRGoals:
    def __init__(self, m3u_dosyasi, kanal_idleri):
        self.m3u_dosyasi = m3u_dosyasi
        self.kanal_idleri = kanal_idleri
    ...
    def m3u_guncelle(self):
        ...
        for kanal_id in self.kanal_idleri:
...
if __name__ == "__main__":
    guncelleyici = TRGoals("1.m3u", kanal_idleri=["yayin1", "yayin2", "yayin3", "yayin4"])
